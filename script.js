...
const SKINS={
default:{name:"Clássica",icon:"🎽",cost:0,desc:"Roupa padrão",className:"skin-default",shirt:"#2674ff"},
ocean:{name:"Oceano Neon",icon:"🌊",cost:750,desc:"Brilho azul especial",className:"skin-ocean",shirt:"#00b8d9"},
shadow:{name:"Sombra",icon:"🌑",cost:1200,desc:"Visual escuro premium",className:"skin-shadow",shirt:"#202637"},
mint:{name:"Menta",icon:"🍃",cost:1500,desc:"Visual refrescante",className:"skin-mint",shirt:"#20c997"},
candy:{name:"Algodão-Doce",icon:"🍭",cost:1800,desc:"Visual doce e colorido",className:"skin-candy",shirt:"#ff7ab6"},
gold:{name:"Ouro",icon:"✨",cost:2500,desc:"Roupa dourada",className:"skin-gold",shirt:"#d99b18"},
emerald:{name:"Esmeralda",icon:"💚",cost:3000,desc:"Visual raro verde",className:"skin-emerald",shirt:"#168a67"},
lava:{name:"Lava",icon:"🔥",cost:4000,desc:"Efeito quente",className:"skin-lava",shirt:"#e53e3e"},
ice:{name:"Gelo",icon:"❄️",cost:4500,desc:"Visual congelante",className:"skin-ice",shirt:"#68c9f0"},
galaxy:{name:"Galáxia",icon:"🌌",cost:5000,desc:"Visual espacial",className:"skin-galaxy",shirt:"#5531b8"},
royal:{name:"Real",icon:"👑",cost:6000,desc:"Visual de realeza",className:"skin-royal",shirt:"#6b3fc9"},
cosmic:{name:"Cosmos",icon:"🪐",cost:7000,desc:"Visual cósmico raro",className:"skin-cosmic",shirt:"#293b8f"},
plasma:{name:"Plasma",icon:"⚡",cost:8000,desc:"Energia elétrica",className:"skin-plasma",shirt:"#e64cff"},
diamond:{name:"Diamante",icon:"💎",cost:9000,desc:"Visual cristalino",className:"skin-diamond",shirt:"#6b9cff"},
rgb:{name:"RGB Lendária",icon:"🌈",cost:10000,desc:"Roupa RGB animada • aparece no ranking",className:"skin-rgb",shirt:"rgb"},
rainbow:{name:"Arco-Íris",icon:"🌈",cost:12000,desc:"Cores do arco-íris",className:"skin-rainbow",shirt:"rgb"},
champion:{name:"Campeão",icon:"🏆",cost:15000,desc:"Visual exclusivo",className:"skin-champion",shirt:"#f2b632"},
master:{name:"Mestre",icon:"👑",cost:20000,desc:"A skin mais rara da loja",className:"skin-master",shirt:"#a855f7"}
};
...
let customization={animal:"fox",fur:null,shirt:"#2674ff",head:"cap",accessory:"none",headColor:"#2674ff",accessoryColor:"#ffd166",eyeColor:"#182033",skin:"default"};
...
function clothingSVG(){
 const skinId=customization.skin||"default";
 const skin=SKINS[skinId]||SKINS.default;
 const shirt=(skin.shirt&&skin.shirt!=="rgb")?skin.shirt:(customization.shirt||"#2674ff");
 let defs="",fill=shirt;
 ...
 if(skinId==="rgb" || skinId==="rainbow"){
   defs=`<linearGradient id="rgbSkinGradient" x1="0%" y1="0%" x2="100%" y2="100%">
   <stop offset="0%" stop-color="#ff2d55"><animate attributeName="stop-color" values="#ff2d55;#ffd60a;#00e5ff;#7c3aed;#ff2d55" dur="2.5s" repeatCount="indefinite"/></stop>
   <stop offset="50%" stop-color="#00e5ff"><animate attributeName="stop-color" values="#00e5ff;#7c3aed;#ff2d55;#ffd60a;#00e5ff" dur="2.5s" repeatCount="indefinite"/></stop>
   <stop offset="100%" stop-color="#7c3aed"><animate attributeName="stop-color" values="#7c3aed;#ff2d55;#ffd60a;#00e5ff;#7c3aed" dur="2.5s" repeatCount="indefinite"/></stop>
   </linearGradient>`;
   fill="url(#rgbSkinGradient)";
   detail=`<circle cx="110" cy="205" r="20" fill="#fff" opacity=".96"/><path d="M100 205L108 213L123 195" fill="none" stroke="#7c3aed" stroke-width="6" stroke-linecap="round"/>`;
 }
 if(skinId==="ocean") defs=`<linearGradient id="skinOcean" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#00d4ff"/><stop offset="1" stop-color="#246bff"/></linearGradient>`,fill="url(#skinOcean)";
 if(skinId==="gold") defs=`<linearGradient id="skinGold" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#fff0a8"/><stop offset=".45" stop-color="#f4b82f"/><stop offset="1" stop-color="#a96b00"/></linearGradient>`,fill="url(#skinGold)";
 if(skinId==="galaxy"||skinId==="cosmic") defs=`<linearGradient id="skinGalaxy" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#11154d"/><stop offset=".5" stop-color="#6d28d9"/><stop offset="1" stop-color="#ec4899"/></linearGradient>`,fill="url(#skinGalaxy)";
 if(skinId==="diamond"||skinId==="ice") defs=`<linearGradient id="skinIce" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#e8fbff"/><stop offset=".5" stop-color="#72c9ff"/><stop offset="1" stop-color="#5276ff"/></linearGradient>`,fill="url(#skinIce)";
 if(skinId==="lava") defs=`<linearGradient id="skinLava" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#ffb000"/><stop offset=".5" stop-color="#ff3d3d"/><stop offset="1" stop-color="#7a1020"/></linearGradient>`,fill="url(#skinLava)";
 if(skinId==="shadow") fill="#151b2d";
 if(skinId==="mint"||skinId==="emerald") defs=`<linearGradient id="skinGreen" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#65f2c0"/><stop offset="1" stop-color="#087f61"/></linearGradient>`,fill="url(#skinGreen)";
 if(skinId==="candy") defs=`<linearGradient id="skinCandy" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#ff9ecb"/><stop offset=".5" stop-color="#ff70a8"/><stop offset="1" stop-color="#8d5cf6"/></linearGradient>`,fill="url(#skinCandy)";
 if(skinId==="royal"||skinId==="master") defs=`<linearGradient id="skinRoyal" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#c084fc"/><stop offset=".5" stop-color="#7c3aed"/><stop offset="1" stop-color="#28124d"/></linearGradient>`,fill="url(#skinRoyal)";
 if(skinId==="plasma") defs=`<linearGradient id="skinPlasma" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#ff4dff"/><stop offset=".5" stop-color="#7c3aed"/><stop offset="1" stop-color="#00e5ff"/></linearGradient>`,fill="url(#skinPlasma)";
 if(skinId==="champion") defs=`<linearGradient id="skinChampion" x1="0" y1="0" x2="1" y2="1"><stop stop-color="#fff0a8"/><stop offset=".5" stop-color="#f2b632"/><stop offset="1" stop-color="#8b5e00"/></linearGradient>`,fill="url(#skinChampion)";

 if(customization.animal==="fox"&&skinId==="default") detail=`<path d="M92 189L110 179L128 189L121 215H99Z" fill="#fff" opacity=".95"/><path d="M110 183V211M99 198H121" stroke="#ff7b2f" stroke-width="4"/>`;
 return `${defs}<path d="M50 243Q54 177 110 176Q166 177 170 243Z" fill="${fill}"/><path d="M78 180Q66 204 67 243M142 180Q154 204 153 243" fill="none" stroke="#fff" opacity=".16" stroke-width="8"/>${detail}`;
}
...
if(saved){
  try{
    ...
    player.ownedSkins=Array.from(new Set(player.ownedSkins||["default"]));
    player.equippedSkin=player.equippedSkin||customization.skin||"default";
    customization.skin=player.equippedSkin;
    syncLocalRank();
  }catch(e){}
}
}
...
function savePlayer(){
 player.customization={...customization};
 player.equippedSkin=customization.skin||player.equippedSkin||"default";
 player.ownedSkins=Array.from(new Set(player.ownedSkins||["default"]));
...
async function startLogin(){
  ...
  player.name=name;
  loadPlayer();
  const loginBtn=document.getElementById("startButton");
  if(loginBtn){loginBtn.disabled=true;loginBtn.textContent="Carregando...";}
  try{
    if(window.FirebaseRanking && FirebaseRanking.isConfigured()){
      const cloud=await FirebaseRanking.loadProfile(name);
      if(cloud){
        player={...player,...cloud,name:name};
        if(cloud.customization) customization={...customization,...cloud.customization};
        player.ownedSkins=Array.from(new Set(cloud.ownedSkins||player.ownedSkins||["default"]));
        player.equippedSkin=cloud.equippedSkin||customization.skin||"default";
        customization.skin=player.equippedSkin;
        syncLocalRank();
        savePlayer();
      }
    }
  }catch(e){console.warn("Perfil online indisponível:",e);}
  finally{
    if(loginBtn){loginBtn.disabled=false;loginBtn.textContent="Entrar";}
    selectedGrade=player.grade||"g5";buildGradeOptions();showScreen("gradeScreen");
  }
}
...
document.getElementById("enterGameButton").onclick=()=>{
  ...
  savePlayer();saveCloudProfile();
  updateDashboard();
  showScreen("menuScreen");
};
document.getElementById("editorBack").onclick=()=>{savePlayer();saveCloudProfile();buildGradeOptions();showScreen("gradeScreen");};
...
async function updateDashboard(){
  ...
  if(window.FirebaseRanking && FirebaseRanking.isConfigured()){
    try{
      ...
      if(cloud){
        if(Number.isFinite(Number(cloud.points)) && Number(cloud.points)>=Number(player.points||0)){
          player.points=Number(cloud.points);
          player.xp=player.points;
        }
        if(Number.isFinite(Number(cloud.coins)) && Number(cloud.coins)>=Number(player.coins||0)) player.coins=Number(cloud.coins);
        if(cloud.customization){
          customization={...customization,...cloud.customization};
          player.customization={...customization};
        }
        player.ownedSkins=Array.from(new Set([...(player.ownedSkins||["default"]),...(cloud.ownedSkins||[])]));
        player.equippedSkin=cloud.equippedSkin||player.equippedSkin||"default";
        customization.skin=player.equippedSkin;
        syncLocalRank();
        savePlayer();
      }
...
function createRankingCharacter(animal,custom){
  const saved=JSON.parse(JSON.stringify(customization));
  customization={...saved,...(custom||{}),animal:['fox','panda','cat','rabbit','dog','tiger'].includes(animal)?animal:'fox'};
...
function renderRanking(players){
  ...
  players.slice(0,10).forEach((p,i)=>{
    ...
    row.innerHTML=`<strong>${medal}</strong><div class="ranking-player"><div class="rank-avatar">${createRankingCharacter(p.character,p.customization)}</div><strong>${escapeHTML(p.name||'Jogador')}</strong></div><div class="rank-points">${Number(p.points)||0}</div><div class="rank-level">Nível ${Number(p.level)||1}</div>`;
    box.appendChild(row);
  });
}
async function sendScoreOnline(){
  ...
  try{
    ...
    const saved=await FirebaseRanking.saveScore({
      ...
      ownedSkins:[...(player.ownedSkins||["default"])],
      equippedSkin:customization.skin||"default",
      analytics:{
...
function saveCloudProfile(){
  if(window.FirebaseRanking && FirebaseRanking.isConfigured() && player.name){
    FirebaseRanking.saveProfile({
      name:player.name,grade:player.grade,points:player.points,level:player.level,
      rank:player.rank,coins:player.coins,character:player.character,
      customization:{...customization},
      ownedSkins:[...(player.ownedSkins||["default"])],
      equippedSkin:customization.skin||"default"
    }).catch(e=>console.warn("Perfil cloud:",e));
  }
}
function skinOwned(id){return (player.ownedSkins||["default"]).includes(id);}
function equipSkin(id){
  if(!skinOwned(id))return;
  player.equippedSkin=id;
  customization.skin=id;
  player.customization={...customization};
  savePlayer();saveCloudProfile();
  refreshCharacter();renderSkinShop();updateCoinUI();
}
function buySkin(id){
  const item=SKINS[id];
  if(!item || id==="default")return equipSkin(id);
  if(skinOwned(id)){equipSkin(id);return;}
  const cost=Number(item.cost)||0;
  if((player.coins||0)<cost){
    alert(`Você precisa de ${cost.toLocaleString("pt-BR")} moedas para comprar ${item.name}.`);
    return;
  }
  player.coins-=cost;
  player.ownedSkins=Array.from(new Set([...(player.ownedSkins||["default"]),id]));
  equipSkin(id);
}
function renderSkinShop(){
  const box=document.getElementById("skinShopItems");
  if(!box)return;
  box.innerHTML=Object.entries(SKINS).map(([id,it])=>{
    const owned=skinOwned(id), equipped=(customization.skin||"default")===id;
    return `<div class="skin-card ${equipped?"equipped":""}">
      <div class="skin-preview ${it.className}"><span>${it.icon}</span></div>
      <div class="skin-info"><strong>${it.name}</strong><small>${it.desc}</small>
      <b>${it.cost===0?"GRÁTIS":it.cost.toLocaleString("pt-BR")+" 🪙"}</b></div>
      <button class="skin-buy-btn ${equipped?"selected":""}" data-skin="${id}">${equipped?"✓ EQUIPADA":owned?"EQUIPAR":`COMPRAR`}</button>
    </div>`;
  }).join("");
  box.querySelectorAll("[data-skin]").forEach(b=>b.onclick=()=>buySkin(b.dataset.skin));
}
